...
// Add a draggable, resizable guide rectangle to visually decide the print area
...
// Log the exact left/top/width/height of the guide (to copy into createPrintArea)
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2.5. Create the fixed print area frame
    // (adjust numbers in createPrintArea once you have values from getGuideValues)
    createPrintArea();
...
function createPrintArea() {
    ...
    printArea = new fabric.Rect({
        left: 186,      // from 185.7360...
        top: 86,        // from 86.0625...
        width: 232,     // from 231.7639...
        height: 441,    // same as logged
...
function loadProductImage(product, color) {
    ...
    fabric.Image.fromURL(imageUrl, function(img) {
        ...
        // Re-add previous design objects on top (includes printArea/guide if they exist)
