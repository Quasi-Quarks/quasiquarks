...
// Product base images (you must create these image files in /images/)
const productImages = {
    tshirt: {
...
let printArea;  // Frame where designs must stay
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // 2.5. Create the print area frame (adjust numbers inside createPrintArea)
    createPrintArea();
    ...
    // 6. Keep design elements inside the print area
...
function createPrintArea() {
    // 🔧 Adjust these numbers to match your shirt mockup
    printArea = new fabric.Rect({
        left: 150,    // move right (+) / left (–)
        top: 120,     // move down (+) / up (–)
        width: 300,   // wider / narrower
        height: 380,  // taller / shorter
...
function keepObjectInPrintArea(obj) {
    ...
    // Don’t clamp the base shirt or the frame itself
